This code accompanies the paper "Fair Clustering for Diverse and Experienced Groups".
...
-The files containing "parsing" in the name were used to parse code from datadumps. As the size of the dumps is on the order of hudreds of gigabytes, they are excluded from the submission
